...
import { schemaSubscription } from "./rules/schema-subscription";
...
function main() {
    program
        ...
        .option("--subscriptions", "enable subscriptions")
        .argument("<string>", "typedefs file");
    ...
    if (options.output) {
        ...
        fs.writeFileSync(options.output, updatedTypedefs);
    } else {
